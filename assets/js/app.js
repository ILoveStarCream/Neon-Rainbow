...
let modals = document.querySelectorAll(".card-modal");
let btnShowModal = document.querySelectorAll(".js-open-modal");
let closeModal = document.querySelectorAll(".js-modal-close");

btnShowModal.forEach((btn) => {
   btn.addEventListener("click", () => {

      // code slider in modal
      modals.forEach(modal => {
         if (modal.dataset.name == btn.dataset.name) {
            modal.classList.add("hide");

            let flkty3 = new Flickity('.big-image-carousel');
            let buttonGroup = document.querySelector('.gallery-button-group');

            buttonGroup.addEventListener('click', function (event) {
               // filter for button clicks
               if (!matchesSelector(event.target, '.gallery-modal-button')) {
                  return;
               }
               let selector = event.target.getAttribute('data-selector');
               flkty3.selectCell(selector);
            });
         }
      })
   });
...
let elem = document.querySelector('.portfolio-main-carousel');
...
let elem1 = document.querySelector('.gallery-carousel');
...
let elem4 = document.querySelector('.rent-main-carousel');
...
tabs.forEach(item => {
    ...
    let itemTabsContent = item.querySelectorAll(".tabs__content-item");
    ...
    itemTabs.forEach((tab) => {
        tab.addEventListener("click", () => {
            ...
            itemTabsContent.forEach((elem) => {
                elem.classList.contains("tabs__content-item--active") ? elem.classList.remove("tabs__content-item--active") : null;
                elem.dataset.id === tab.dataset.id ? elem.classList.add("tabs__content-item--active") : null;
            });
...
document.querySelector('.hide-nav').onclick = open;
...
document.querySelector('.main-nav-close').onclick = () => {
